...
public class Noeud implements Parcelable, Comparable<Noeud> {
	...
	// si un point a une latitude supérieur à l'autre il est plus en haut
	// si un point a une longitude supérieur à l'autre il est plus à droite
	@Override
